...
for row in range(0, 3):
    ...
    box4[row] = sd.createARandomNumber(numberInSameRow, numberInSameColumn, numberInSameBox)
#all 3 rows in box5
for row in range(0, 3):
   ...
   # box5[row] = sd.createARandomNumber(numberInSameRow, numberInSameColumn, numberInSameBox)
...
for row in range(0, 3):
    ...
    box6[row] = sd.createARandomNumber(numberInSameRow,numberInSameColumn,numberInSameBox)
...
for row in range(0, 3):
    ...
    box7[row + 3] = sd.createARandomNumber(numberInSameRow,numberInSameColumn,numberInSameBox)
...
for row in range(0, 3):
    ...
    box9[row] = sd.createARandomNumber(numberInSameRow, numberInSameColumn, numberInSameBox)
