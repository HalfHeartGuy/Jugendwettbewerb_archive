...
selected_chess_piece = one_chess_game.check_piece_for_position(1,1)
one_chess_game.player1.move_one_chess_piece(selected_chess_piece, 1, 2)
...
print(one_chess_game.check_piece_for_position(-1,7))
