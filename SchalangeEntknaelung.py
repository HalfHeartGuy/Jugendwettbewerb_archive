...
zwoelfteSchlange = [{'start': [-19, 7], 'stop': [-18, 7], 'color': 'orange'}
    ...
    , {'start': [-2, 7], 'stop': [-1, 7], 'color': 'orange'}

    , {'start': [-1, 7], 'stop': [0, 7], 'color': 'orange'}
    , {'start': [0, 7], 'stop': [1, 7], 'color': 'orange'}
    , {'start': [1, 7], 'stop': [2, 7], 'color': 'orange'}

    , {'start': [2, 7], 'stop': [3, 7], 'color': 'orange'}
    , {'start': [3, 7], 'stop': [4, 7], 'color': 'orange'}
    , {'start': [4, 7], 'stop': [5, 7], 'color': 'orange'}
    , {'start': [5, 7], 'stop': [6, 7], 'color': 'orange'}
    , {'start': [6, 7], 'stop': [7, 7], 'color': 'orange'}
    , {'start': [7, 7], 'stop': [8, 7], 'color': 'orange'}
    , {'start': [8, 7], 'stop': [9, 7], 'color': 'orange'}
    , {'start': [9, 7], 'stop': [10, 7], 'color': 'orange'}
    , {'start': [10, 7], 'stop': [11, 7], 'color': 'orange'}
    , {'start': [11, 7], 'stop': [12, 7], 'color': 'orange'}
    , {'start': [12, 7], 'stop': [13, 7], 'color': 'orange'}
    , {'start': [13, 7], 'stop': [14, 7], 'color': 'orange'}
    , {'start': [14, 7], 'stop': [15, 7], 'color': 'orange'}
    , {'start': [15, 7], 'stop': [16, 7], 'color': 'orange'}
    , {'start': [16, 7], 'stop': [17, 7], 'color': 'orange'}
